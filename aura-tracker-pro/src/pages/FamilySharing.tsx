...
import { Users, Plus, UserPlus, Mail, DollarSign, Trash2, Edit, Check, X, Crown, Shield, Loader2, Clock, Lock } from "lucide-react";
            ...
            <Card className="relative overflow-hidden">
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-background/80 backdrop-blur-sm">
                <div className="text-center space-y-4 p-8 max-w-md">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-2">Unlock Family Sharing</h3>
                    <p className="text-muted-foreground text-sm">
                      Share subscriptions with family and friends, split costs, and manage group expenses together.
                    </p>
                  </div>
                  <div className="space-y-2">
                    <ul className="text-sm text-left space-y-2 bg-muted/50 rounded-lg p-4">
                      <li className="flex items-center gap-2">
                        ...
                        <span>Create unlimited sharing groups</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <DollarSign className="h-4 w-4 text-primary" />
                        <span>Auto-split subscription costs</span>
                      </li>
                      <li className="flex items-center gap-2">
